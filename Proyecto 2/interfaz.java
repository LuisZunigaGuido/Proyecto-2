    ...
    public Interfaz() {
        ...
        botonEliminar.addActionListener(e->{
            ...
            try{
                ...
                if(lista.buscarDato(numeroEliminar)!=null){
                   ...
                   JOptionPane.showMessageDialog(null, "Error al eliminar dato, ingrese un valor entero valido de la lista :)");
            }
        ...
        botonBuscar.addActionListener(e->{
            ...
            try{
               ...
               JOptionPane.showMessageDialog(null,"Error, favor de ingresar un entero válido para realizar la busqueda :)");
            }
        });
